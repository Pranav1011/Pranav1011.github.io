...
toolkit:
  - group: LLMs and agents
    items: [LangGraph, LangChain, MCP, OpenAI API, Claude API, Ollama]
  - group: Retrieval
    items: [RAG, HyDE, Chroma, Qdrant, Neo4j]
  - group: Evaluation and modelling
    items: [LLM-as-a-judge, eval harnesses, statsmodels, pandas, NumPy]
  - group: Serving and reliability
    items: [FastAPI, Redis/RQ, Docker, GitHub Actions, Langfuse]
  - group: Data
    items: [PostgreSQL, TimescaleDB, SQLite, SQL]
  - group: Languages and front end
    items: [Python, TypeScript, React, Next.js]
education:
  - degree: MS, Data Analytics Engineering
    school: Northeastern University
    dates: Sep 2024 – Dec 2026
    detail: "GPA 3.95. Coursework: Machine Learning Operations, Deep Learning for AI, Data Mining in Engineering"
...
<!-- src: toolkit — each item used in Aurora, F1 RIA or PitWall, or at GPT Integrators / Tally:
       ...
       statsmodels, pandas, NumPy — PitWall pyproject.toml
       OpenAI API, FastAPI — GPT Integrators; PostgreSQL, SQL — Tally (private: SOURCES.md) -->
<!-- src: GPA — academic records (private: SOURCES.md) -->
<!-- src: coursework — academic records (private: SOURCES.md) -->
<!-- src: cta — owner-approved copy -->
